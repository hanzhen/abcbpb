...
//    us nsuserdefaults -- not passing string anymore...
    ...
    // but i want to get L2,  L2R from NSuserdefaults here.
    // what to get kPhoneLang 
    ...
    // based on kPhoneLang -- not kL1 which is always english. no way to override these - match phone or english.
    // can set L2 here. only set L2R in settings.
    //
...
//  show other nsUserDefaults
    ...
    //		NSLog(@"\n\nGot DB version of: %@.\n", dbVer.text);
// LxR not usedin this app. only accessible in settings. defaults to NO, assumed to be users's first language.
