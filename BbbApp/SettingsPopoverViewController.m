...
// note: here only set L2 choice with user selection. setting back to english is unselect.
// stored in datbase.  lables set by value stored at startup, based on phone language, not L1 (not used) or L2.
// 
...
//    [self setLabelBGColor:(_textSetNameEtc) toColorIDX:l1Val];
    [self setLabelBGColor:(_colorStrip) toColorIDX:(lL2)];   // USE L2 value here.  BBB uses L1!!!
